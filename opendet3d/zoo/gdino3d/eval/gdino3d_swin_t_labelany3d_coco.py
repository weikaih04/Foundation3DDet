"""3D-MOOD with Swin-T for LabelAny3D COCO evaluation."""
...
from opendet3d.zoo.gdino3d.base.dataset.open import get_labelany3d_coco_data_cfg
...
def get_config() -> ExperimentConfig:
    """Returns the 3D-MOOD with Swin-T for LabelAny3D COCO evaluation."""
    ######################################################
    ##                    General Config                ##
    ######################################################
    config = get_default_cfg(exp_name="gdino3d_swin-t_labelany3d_coco")
    ...
    ######################################################
    # LabelAny3D COCO uses regular jpg files, not HDF5
    test_datasets_cfg = [
    ...
    ##                  MODEL & LOSS                    ##
    ######################################################
    # Set pretrained=None since we're loading from checkpoint via --ckpt
    # This avoids downloading GroundingDINO pretrained weights
