"""3D-MOOD with Swin-T for Argoverse evaluation."""
...
def get_config() -> ExperimentConfig:
    """Returns the 3D-MOOD with Swin-T for Argoverse evaluation."""
    ######################################################
    ##                    General Config                ##
    ######################################################
    config = get_default_cfg(exp_name="gdino3d_swin-t_argoverse")
