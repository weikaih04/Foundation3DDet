"""SAM3_3D with LingBot-Depth on Omni3D - GT Box Oracle + GT Depth Input.
...
This is the upper-bound oracle: perfect 2D detection + perfect depth input.
...
def get_config() -> ExperimentConfig:
    """Returns oracle + GT depth input eval config for SAM3_3D + LingBot."""
    ######################################################
    ##                    General Config                ##
    ######################################################
    config = get_default_cfg(
        exp_name="sam3_3d_lingbot_depth_freeze21_omni3d_oracle_depth_input"
    )
