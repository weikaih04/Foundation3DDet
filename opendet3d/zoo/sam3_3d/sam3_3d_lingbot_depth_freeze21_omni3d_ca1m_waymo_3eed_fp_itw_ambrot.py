"""SAM3_3D + LingBot-Depth + all datasets + ITW + Ambiguous Rotation.

Same as _3eed_fp_itw but with ambiguous_rotation=True to normalize
GT yaw to [0, 180), eliminating 180-degree rotation ambiguity in
training loss.

Usage:
    vis4d fit --config opendet3d/zoo/sam3_3d/sam3_3d_lingbot_depth_freeze21_omni3d_ca1m_waymo_3eed_fp_itw_ambrot.py --gpus 8
"""
...
def get_config() -> ExperimentConfig:
    """Returns SAM3_3D + LingBot + all datasets + ITW + ambiguous rot."""
    ######################################################
    ##                    General Config                ##
    ######################################################
    config = get_default_cfg(
        exp_name=(
            ...
            "_omni3d_ca1m_waymo_3eed_fp_itw_ambrot"
        )
    )
