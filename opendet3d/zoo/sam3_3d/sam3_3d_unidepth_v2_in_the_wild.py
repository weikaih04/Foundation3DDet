"""SAM3_3D with UniDepth V2 on InTheWild - Text mode evaluation.
...
Mode: text prompts, monocular depth from UniDepth V2 (no GT depth input).
"""
...
def get_config() -> ExperimentConfig:
    """Returns SAM3_3D + UniDepth V2 text eval config for InTheWild."""
    config = get_default_cfg(
        exp_name="sam3_3d_unidepth_v2_in_the_wild"
    )
