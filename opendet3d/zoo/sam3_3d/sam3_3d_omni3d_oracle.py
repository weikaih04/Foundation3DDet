"""SAM3_3D Oracle Evaluation with Full Omni3D Dataset.
...
Usage:
    vis4d test --config opendet3d/zoo/sam3_3d/sam3_3d_omni3d_oracle.py \
        --gpus 1 \
...
def get_config() -> ExperimentConfig:
    """Returns oracle evaluation config for SAM3_3D on full Omni3D."""
    ######################################################
    ##                    General Config                ##
    ######################################################
    config = get_default_cfg(exp_name="sam3_3d_omni3d_oracle")
