"""SAM3_3D with UniDepth V2 on InTheWild - Oracle evaluation.

Evaluates SAM3_3D + UniDepth V2 (120e) on the InTheWild benchmark.

Mode: GT 2D boxes as geometry prompts (oracle), monocular depth from UniDepth V2.
...
def get_config() -> ExperimentConfig:
    """Returns SAM3_3D + UniDepth V2 oracle eval config for InTheWild."""
    config = get_default_cfg(
        exp_name="sam3_3d_unidepth_v2_in_the_wild_oracle"
    )
