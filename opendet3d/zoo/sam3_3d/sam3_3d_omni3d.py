...
def get_config() -> ExperimentConfig:
    ...
    # Note: Learning rate control for pretrained components (SAM3 backbone, geometry encoder)
    # is handled by param_groups in get_sam3_3d_optim_cfg, not by freezing.
    # Default: backbone/encoder use 0.1x lr, 3D head uses 1.0x lr
