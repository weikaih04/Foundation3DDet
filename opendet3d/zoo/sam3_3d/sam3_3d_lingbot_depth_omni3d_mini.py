"""SAM3_3D with LingBot-Depth geometry backend on Omni3D Mini Dataset.

For fast profiling and debugging. Uses mini datasets (100 samples per dataset).

Usage:
    vis4d fit --config opendet3d/zoo/sam3_3d/sam3_3d_lingbot_depth_omni3d_mini.py --gpus 2
"""
...
def get_config() -> ExperimentConfig:
    """Returns the SAM3_3D + LingBot-Depth mini configuration."""
    ######################################################
    ##                    General Config                ##
    ######################################################
    config = get_default_cfg(exp_name="sam3_3d_lingbot_depth_omni3d_mini")
